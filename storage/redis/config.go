...
func configDefault(config ...Config) Config {
	...
	if cfg.MasterName == "" {
		cfg.MasterName = ConfigDefault.MasterName
	}
	if cfg.ClientName == "" {
		cfg.ClientName = ConfigDefault.ClientName
	}
	if cfg.SentinelUsername == "" {
		cfg.SentinelUsername = ConfigDefault.SentinelUsername
	}
	if cfg.SentinelPassword == "" {
		cfg.SentinelPassword = ConfigDefault.SentinelPassword
	}
	if cfg.TLSConfig == nil {
		cfg.TLSConfig = ConfigDefault.TLSConfig
	}
	// Reset doesn't need default setting as false is the default value
